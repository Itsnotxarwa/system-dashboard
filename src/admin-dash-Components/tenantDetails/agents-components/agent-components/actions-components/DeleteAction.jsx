...
export default function DeleteAction({ actionName, onConfirm, onClose }) {
    return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(10,22,40,0.38)] backdrop-blur-sm p-5">
        ...
        w-full shadow-2xl shadow-red-100/50 overflow-hidden lg:max-w-md">
            <div class="h-1 bg-linear-to-r from-red-500 to-red-400"></div>

            <div class="px-7 py-8 text-center">
                <div class="w-14 h-14 rounded-full bg-red-50 border border-red-100 flex 
                ...
                <p class="text-xs text-slate-400 leading-relaxed mb-1">
                    Are you sure you want to delete this action <strong className="text-red-500">{actionName}</strong> ?
                </p>

                <div class="flex items-start gap-2.5 bg-red-50 border border-red-100 rounded-xl p-3 mb-6 text-left">
                    <span class="text-yellow-500 mt-px shrink-0">
                        <TriangleAlert />
                    </span>
