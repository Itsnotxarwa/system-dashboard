    ...
    return(
        ...
        backdrop-blur-sm p-5">
            ...
            shadow-[-4px_0_24px_rgba(0,0,0,.4)] ${
                ...
                {/* HEADER */}
                <div className="sticky top-0 z-10 flex items-center gap-3 px-5 py-4 border-b border-[#21262d]
                bg-[#161b22]">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="font-semibold text-[#e6edf3] text-sm tracking-tight font-sans">
                            Session Details
                        </div>
                ...
                <div className="flex-1 overflow-y-auto p-5 flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <div className="p-3 rounded-[10px] bg-[#0d1117] border border-[#21262d]">
                            <div className="flex items-center gap-1 text-[9px] text-[#8b949e] uppercase tracking-widest mb-1">
                    ...
                    {parsedTranscription.length > 0 && (
                        <div className="flex flex-wrap gap-2">
                            <span className="text-[11px] px-2.5 py-1 rounded-md bg-[#0d1117] text-[#8b949e] border 
                            border-[#21262d] font-mono">
                                {parsedTranscription.length} messages
                            </span>
                            <span className="text-[11px] px-2.5 py-1 rounded-md bg-[rgba(88,166,255,.08)] text-[#58a6ff] border 
                            border-[rgba(88,166,255,.2)] font-mono flex items-center gap-1">
                                <Bot size={11} />
                                {parsedTranscription.filter(m => m.role === "assistant").length} AI
                            </span>
                            <span className="text-[11px] px-2.5 py-1 rounded-md bg-[#0d1117] text-[#8b949e] border 
                            border-[#21262d] font-mono flex items-center gap-1">
                                <User size={11} />
                        ...
                        <div className="flex flex-col gap-3 pb-3">
                            {parsedTranscription.map((msg, i) => {
                                ...
                                <div key={i} className={`flex gap-2 ${isAI ? "" : "flex-row-reverse"}`}>
                                    ...
                                    >
                                        <div className="text-[10px] uppercase font-semibold mb-1.5 flex items-center gap-1 font-mono
                                        text-[#8b949e]">
                                            {isAI ? (
